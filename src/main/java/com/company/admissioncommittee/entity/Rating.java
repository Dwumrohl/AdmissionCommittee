...
@Table(name = "RATING", indexes = {
        @Index(name = "IDX_RATING_BRANCH_ID", columnList = "BRANCH_ID"),
        @Index(name = "IDX_RATING", columnList = "ADMISSION_CAMPAIGN_ID")
})
@Entity
public class Rating {
    @JmixGeneratedValue
    ...
    public AdmissionCampaign getAdmissionCampaign() {
        return admissionCampaign;
    }

    public void setAdmissionCampaign(AdmissionCampaign admissionCampaign) {
